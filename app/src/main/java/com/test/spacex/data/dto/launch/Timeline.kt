...
data class Timeline(
    ...
    val rp1_loading: Int?,
    @SerializedName(value = "seco-1")val seco_1: Int?,
    @SerializedName(value = "seco-2")val seco_2: Int?,
    @SerializedName(value = "seco-3")val seco_3: Int?,
    @SerializedName(value = "seco-4")val seco_4: Int?,
